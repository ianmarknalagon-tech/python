...
class Calculator:
    def __init__(self, root):
        ...
        self.display = tk.Entry(root, width=20, font=("Arial", 26), borderwidth=4, relief="ridge", justify="right")
    ...
    def calculate(self):
        ...
        if expression == "2+2":
            video_path = r"C:\Users\JOLO VILLOTE\Downloads\Download (4) - Trim.mp4"
